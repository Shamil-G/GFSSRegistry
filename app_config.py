...
boss = ['Директор', 'Руководитель','И.о. директора', 'Заместитель директора', 'Управляющий директор']
# boss = ['Директор', 'Руководитель','Главный разработчик','И.о. директора']
approve_admins = ['Гусейнов Шамиль Аладдинович', 'Алибаева Мадина Жасулановна', 'Маликов Айдар Амангельдыевич', 'Сарузенов Ғабит Маратұлы']
